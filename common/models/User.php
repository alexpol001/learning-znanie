...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return static::findOne(['student_id' => $student_id, 'status' => [self::STATUS_ACTIVE, self::STATUS_ADMIN]]);
    }
    ...
    {
        return self::findOne(['status' => self::STATUS_ADMIN]);
    }

    public function sendEmailAboutNewPassword($password) {
        return Yii::$app
            ->mail
            ->compose(
                ['html' => 'new_password-html', 'text' => 'new_password-text'],
                ['password' => $password]
            )
